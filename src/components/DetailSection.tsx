    ...
    return (
        <div className="bg-gradient-to-r from-gray-100 to-gray-300 p-48 flex flex-row justify-center w-full h-[60vh] items-center">
            <div className="flex flex-col">
                <div className="bg-white bg-opacity-80 p-6 rounded-lg shadow-lg flex flex-col w-[35vw] mr-6 m-2 hover:scale-105 transition-transform duration-300">
                ...
                <div className="bg-white bg-opacity-80 p-6 rounded-lg shadow-lg flex flex-col w-[35vw] mr-6 m-2 mt-4 hover:scale-105 transition-transform duration-300">
                    <h1 className="text-3xl font-extrabold text-center text-gray-800">Check out the Company!</h1>
                    <Link href='/company' className="mt-4 px-6 py-2 bg-cyan-600 text-white rounded-lg shadow-md hover:bg-cyan-700 transition-all text-center">
                        Click Here
                    </Link>
                </div>
            </div>
